...
import { PdfH2, PdfH3, PdfTextBold, PdfLink, PdfText } from "../typography";
    ...
    <>
      ...
      >
        <View style={{ marginBottom: theme.spacing.m }}>
          <PdfH2>Das Barrierefreiheitsstärkungsgesetz (BFSG)</PdfH2>
        </View>
        <View bookmark={{ title: "Was ist das BFSG?", fit: true }}>
          <PdfSection>
            <PdfH3>Was ist das BFSG?</PdfH3>
            <PdfText>
              Das{" "}
              <PdfTextBold>Barrierefreiheitsstärkungsgesetz (BFSG)</PdfTextBold>{" "}
              regelt die <PdfTextBold>digitale Barrierefreiheit</PdfTextBold>{" "}
              für bestimmte Produkte und Dienstleistungen verbindlich. Es setzt
              eine EU-Richtlinie um und gilt{" "}
        ...
        <View bookmark={{ title: "Für wen gilt das BFSG?", fit: true }}>
          <PdfSection>
            <PdfH3>Für wen gilt das BFSG?</PdfH3>
            <PdfText>
              ...
              anbieten, zum Beispiel <PdfTextBold>Online-Shops</PdfTextBold>,
              Apps oder Webprojekte mit geschäftlichen Funktionen wie
              Terminbuchungen oder Gutscheinbestellungen. Ausgenommen sind{" "}
              <PdfTextBold>
                Kleinstunternehmen mit weniger als 10 Beschäftigten
              </PdfTextBold>{" "}
              und{" "}
              <PdfTextBold>maximal 2 Millionen Euro Jahresumsatz</PdfTextBold>.
              Weitere Infos im{" "}
        ...
        >
          <PdfSection>
            ...
            <PdfUl>
              ...
              <PdfLi>
                <PdfTextBold>Bessere Conversion Rate:</PdfTextBold>
                Verständliche, klare Interfaces funktionieren für alle Nutzende
                und senken Abbruchraten.
              </PdfLi>
              <PdfLi>
                <PdfTextBold>Positive SEO-Effekte:</PdfTextBold> Saubere
                Struktur, klare Semantik und gute Lesbarkeit wirken sich positiv
                auf Suchmaschinen aus.
              </PdfLi>
              <PdfLi>
                <PdfTextBold>Zukunftssicherheit:</PdfTextBold>
                Barrierefreiheit wird langfristig zum Standard und reduziert
        ...
        >
          <PdfSection>
            <PdfH3>Was passiert bei Verstößen gegen das BFSG?</PdfH3>
            <PdfText>
              Werden die Anforderungen des BFSG nicht erfüllt, stellt dies gemäß{" "}
              <PdfTextBold>§ 37 Abs. 1 Nr. 8 BFSG</PdfTextBold> eine{" "}
              <PdfTextBold>Ordnungswidrigkeit</PdfTextBold> dar und kann mit
              einem <PdfTextBold>Bußgeld von bis zu 100.000 €</PdfTextBold>{" "}
              geahndet werden. Weitaus schlimmer könnten Abmahnungen von
              Mitbewerbern oder sogenannten „Abmahnvereinen“ sein. Die
              Erfahrungen der letzten Jahre zeigen, dass gerade Verstöße gegen
              Informations- und Gestaltungspflichten häufig für{" "}
      ...
      >
        <PdfSection>
          <PdfH2>Hinweis zur Barrierefreiheitserklärung</PdfH2>
          <PdfText>
