  ...
  return (
    <Page size="A4" style={styles.page}>
      ...
      <PdfSection>
        ...
        <PdfUl>
          <PdfLi>
            <PdfTextBold>Größere Zielgruppe:</PdfTextBold> Inhalte sind für mehr
            Menschen nutzbar.
          </PdfLi>
          <PdfLi>
          ...
          <PdfLi>
            <PdfTextBold>Zukunftssicherheit:</PdfTextBold> Barrierefreiheit wird
            langfristig zum Standard und reduziert späteren Anpassungsaufwand.
          </PdfLi>
        </PdfUl>
        <PdfText>
          Barrierefreiheit ist damit nicht nur ein Compliance-Thema, sondern ein
          <PdfTextBold>
