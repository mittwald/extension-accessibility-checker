    ...
    <ColumnLayout m={[1, 1]}>
      <LayoutCard>
        <Section>
          ...
          <Text>
            ...
            vertraut und{" "}
            <Link
              href="https://web.dev/articles/how-to-review?hl=de"
              target="_blank"
            >
      ...
      <LayoutCard>
        <Section>
          ...
          <Link
            href="https://www.mittwald.de/blog/webentwicklung-design/barrierefreiheitsstaerkungsgesetz-inhalt-verpflichtungen-und-ausnahmen"
            target="_blank"
          >
            Blog-Artikel
          </Link>
