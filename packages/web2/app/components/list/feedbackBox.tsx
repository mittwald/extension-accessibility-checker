        ...
        <ColumnLayout l={[3, 1]} m={[2, 1]} s={[1, null]}>
          <Section>
            ...
            <Text>
              ...
              Barriere-Checker besser machen kann. Ob kleiner Bug oder große
              Idee: Ich will’s wissen! Gib mir dein Feedback direkt auf GitHub.
              Dauert nur 1&nbsp;Minute, bringt aber richtig was.
            </Text>
            <Link
              target="_blank"
